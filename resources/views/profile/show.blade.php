            ...
            <div class="bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-400 p-4 sm:p-6 mb-4 sm:mb-6 rounded-xl shadow-md">
                <div class="flex gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <a href="{{ route('profile.edit') }}" class="inline-flex items-center px-4 sm:px-6 py-2.5 sm:py-3 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold rounded-lg shadow-md transition transform hover:scale-105">
